...
export default function HomePage() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section id="how" className="relative py-16 md:py-24">
        ...
        <div className="mx-auto w-full max-w-7xl px-6">
          <div className="glass-card rounded-2xl p-8 shadow-premium">
            <h2 className="text-2xl md:text-3xl font-semibold gradient-text">How it works</h2>
      ...
      </section>Truck, Zap, Globe, Clock, Users, BarChart3, CheckCircle, Star } from 'lucide-react'
import Link from "next/link"
import { Navbar } from "@/components/site/navbar"
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section id="testimonials" className="py-16 md:py-24">
        <div className="mx-auto w-full max-w-7xl px-6">
          <h2 className="text-2xl md:text-3xl font-semibold gradient-text mb-6">Loved by teams</h2>
          <div className="grid gap-6 md:grid-cols-3">
            {Array.from({ length: 3 }).map((_, i) => (
              <Card key={i} className="glass-card p-6 shadow-premium">
                <CardContent className="p-0">
                  <p className="text-neutral-700">“Wayfinder simplifies our logistics tracking and saves us hours weekly.”</p>
                  <div className="mt-4 text-sm text-neutral-500">Operations Lead, Company {i + 1}</div>
                </CardContent>
              </Card>
            ))}
          </div>
